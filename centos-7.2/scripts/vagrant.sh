...
# Examples
# - https://github.com/TFDuesing/packer-templates/blob/master/Fedora-23/scripts/20vagrant.sh
...
curl --location --remote-name https://raw.githubusercontent.com/mitchellh/vagrant/master/keys/vagrant.pub
